    ...
    return (
        ...
        <section className="flexContainer g30 content">
            <section className="column w80">
                ...
                <section className="flexContainer about-section">
                    ...
                    <section className="column w70">
                        <p className="p20">
                            I am a third-year Art and Design: Games and Playable Media studying at UC Santa Cruz. I am
                            dedicated to designing experiences, interfaces, and art that people will interact with and
                            benefit from. Though I am just a student, I believe you can only learn so much in a lecture.
                            I love throwing myself into new endeavors and learning through experience! At my university,
                            ...
                            redevelopment of our website. I have also had had the opportunity to work abroad in Berlin,
                ...
                <section className="flexContainer work-section">
                    ...
                    <section className="column w70 alignCenter">
                        ...
                        {/*a colection of my favorite works over the years*/}
                    </section>
                </section>
            ...
            <section className="column w20">
                ...
                way down there perhaps one of my fav things blah blah annotation at the site of the reading
            </section>
        </section>
